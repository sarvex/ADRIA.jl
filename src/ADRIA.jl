...
include("locations/connectivity.jl")
include("locations/mcda_methods.jl")
include("locations/dMCDA.jl")
include("locations/mcda_criteria.jl")
...
if ccall(:jl_generating_output, Cint, ()) == 1
    ...
    Base.precompile(Tuple{typeof(combine_results),ResultSet{String,Vector{Any},Vector{Any},Vector{Float64},NamedDimsArray{(:timesteps, :locations, :intervention, :scenarios),Float32,4,ZArray{Float32,4,Zarr.BloscCompressor,DirectoryStore}},NamedDimsArray{(:timesteps, :coral_id, :locations, :scenarios),Float32,4,ZArray{Float32,4,Zarr.BloscCompressor,DirectoryStore}},NamedDimsArray{(:timesteps, :locations, :scenarios),Float32,3,ZArray{Float32,3,Zarr.BloscCompressor,DirectoryStore}},Dict{String,AbstractArray},DataFrame}})   # time: 0.9439985
    Base.precompile(Tuple{typeof(rank_locations!),Matrix{Float64},Vector{Float64},Matrix{Int64},Int64,typeof(mcda_topsis),Int64})   # time: 0.3518593
    Base.precompile(Tuple{typeof(rank_locations!),Matrix{Float64},Vector{Float64},Matrix{Int64},Int64,typeof(mcda_vikor),Int64})   # time: 0.3170264
    ...
    Base.precompile(Tuple{typeof(rank_seed_locations!),Matrix{Float64},Vector{Float64},Matrix{Int64},Int64,Function})   # time: 0.1931881
