...
if ccall(:jl_generating_output, Cint, ()) == 1
    ...
    Base.precompile(Tuple{typeof(rank_locations!),Matrix{Float64},Vector{Float64},Matrix{Int64},Int64,typeof(topsis),Int64})   # time: 0.3518593
    Base.precompile(Tuple{typeof(rank_locations!),Matrix{Float64},Vector{Float64},Matrix{Int64},Int64,typeof(vikor),Int64})   # time: 0.3170264
